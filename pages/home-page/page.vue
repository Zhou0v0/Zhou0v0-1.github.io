	...
	<view>
		...
		<view class="top-view">
			...
			<view class="top-view-flex">
				...
				<image src="/static/tab/dingdan.png" mode="widthFix" style="width: 50rpx;height: 50rpx;" @click="my_order()"></image>
			</view>
		</view>
		<view class="order-view">
			...
			<view class="order-bottom" @click="pop_Shopping()" :style="{'padding-bottom': Modelmes ? '68rpx' : ''}">
				...
				<view class="place-order" @click.stop="total_quantity == 0 ? false : true && placean_order()">
					<button plain="true" open-type="getUserInfo">提交</button>
				</view>
			</view>
		</view>
...
export default{
	...
	data() {
		return {
			...
			tmplIds:'GGoyslwCarWdGPHPhyxi35SzpuvxVehVOxTM6LPo8Y8',//模板id
...
.place-order button{
	border: none;
	background:linear-gradient(to right,#ff0000,#f86814,#ff0000);
	width: 200rpx;
	height: 75rpx;
	line-height: 75rpx;
	border-radius: 50rpx;
